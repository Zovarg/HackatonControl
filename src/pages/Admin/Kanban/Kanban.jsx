...
const Kanban = () => {
    ...
    const [fetchTasks, isPostsLoading, postError] = useFetching(async () => {
    ...
    return (
        <div className={cl.container}>
            ...
            <ScrollContainer className={cl.tasks_wrapper}>
                    <div className={cl.taskFunnel}>
                        <div className={cl.taskFunnel__title}>
                            <div className={cl.taskFunnel__title_name}>Еще не начаты <span>29</span></div>
                        </div>
                        <div className={cl.taskFunnel__line}></div>
                        <div className={cl.taskFunnel__list}>
                            <div className={cl.taskFunnel__list_el}>
                                <div className={cl.taskFunnelEl__name}>Электрик</div>
                                <div className={cl.taskFunnelEl__date}>Заявка от 18.02. 08:19</div>
                                <div className={cl.taskFunnelEl__description}>Заменить счетчик электроэнергии</div>
