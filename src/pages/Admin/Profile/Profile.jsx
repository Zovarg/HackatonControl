                ...
                showRedactor?
                    <div className={cl.profileData}>
                        <div className={cl.profileData__header}>
                            ...
                            <div className={cl.profileData__header_edit} onClick={saveProfileFunc}>Сохранить</div>
                        </div>
                        <div className={cl.profileBody}>
                            <div className={cl.profileBody__fields}>
                                <div className={cl.profileBody__field}>
                                    ...
                                    <div className={cl.profileBody__field_value}>
                                        <input
                                            type="text"
                                            value={dataProfile.fio}
                                            onChange={e=>setDataProfile({...dataProfile, fio:e.target.value})}
                                        />
                                    </div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    ...
                                    <div className={cl.profileBody__field_value}>
                                        <input
                                            type="text"
                                            value={dataProfile.organization}
                                            onChange={e=>setDataProfile({...dataProfile, organization:e.target.value})}
                                        />
                                    </div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    ...
                                    <div className={cl.profileBody__field_value}>
                                        <input
                                            ...
                                            onChange={e=>setDataProfile({...dataProfile, phone:e.target.value})}
                                        />
                                    </div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    ...
                                    <div className={cl.profileBody__field_value}>
                                        <input
                                            ...
                                            onChange={e=>setDataProfile({...dataProfile, email:e.target.value})}
                                        />
                                    </div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    ...
                                    <div className={cl.profileBody__field_value}>
                                        <input
                                            ...
                                            onChange={e=>setDataProfile({...dataProfile, city:e.target.value})}
                                        />
                                    </div>
                                </div>
                                <div className={cl.profileBody__field}>
                    ...
                    <div className={cl.profileData}>
                        <div className={cl.profileData__header}>
                            <div className={cl.profileData__header_title}>Данные профиля</div>
                            <div className={cl.profileData__header_edit} onClick={()=>{setShowRedactor(true)}}>Редактировать профиль</div>
                        </div>
                        <div className={cl.profileBody}>
                            <div className={cl.profileBody__fields}>
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>ФИО</div>
                                    <div className={cl.profileBody__field_value}>{dataProfile.fio}</div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>Организация</div>
                                    <div className={cl.profileBody__field_value}>{dataProfile.organization}</div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>Контактный телефон</div>
                                ...
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>Email</div>
                                    <div className={cl.profileBody__field_value}>{dataProfile.email}</div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>Город</div>
                                    <div className={cl.profileBody__field_value}>{dataProfile.city}</div>
                                </div>
                                <div className={cl.profileBody__field}>
                                    <div className={cl.profileBody__field_name}>Способ связи</div>
                                    <div className={cl.profileBody__field_value}>Телефон, email</div>
                                            ...
                                            <div>
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_2313_6049" x1="11" y1="7.76623" x2="4.99994" y2="7.78888" gradientUnits="userSpaceOnUse">
                                                        ...
                                                        <stop offset="0.0001" stopColor="#8244DC"/>
                                                        <stop offset="0.515625" stopColor="#A756CD"/>
                                                        <stop offset="1" stopColor="#BC6EC1"/>
                                                    </linearGradient>
                                                </defs>
                                            </svg>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className={cl.tableStatus4}>
                                            <div>
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11 8C11 9.65685 9.65685 11 8 11C6.34315 11 5 9.65685 5 8C5 6.34315 6.34315 5 8 5C9.65685 5 11 6.34315 11 8Z" fill="black" fillOpacity="0.4"/>
                                                </svg>
                                            </div>
                                            <div>В процессе</div>
                                        </div>
                ...
                <div className={cl.profileMobile}>
                    ...
                    <div className={cl.profileMobile__btns}>
                        ...
                        <div className={cl.profileMobile__btn}>
                            <div>
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_2313_24116)">
